    ...
    "</ul></div>", unsafe_allow_html=True)
        ...
        with analyzer_tabs[1]:
            ...
            <div style='background-color: #1e1e1e; padding: 20px; border-radius: 10px; margin: 10px 0;'>
                ...
                <p>Get detailed insights from an advanced AI model that can analyze your resume and provide personalized recommendations.</p>
        ...
        unsafe_allow_html=True
                ...
                if analyze_ai:
                    with st.spinner(f"Analyzing your resume with Google Gemini..."):
                        # Get file content
                        text = ""
                        try:
                            if uploaded_file.type == "application/pdf":
